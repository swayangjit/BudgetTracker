...
public class InventoryAdapter extends RecyclerView.Adapter<InventoryAdapter.InventoryViewHolder> implements View.OnClickListener, View.OnLongClickListener {

    private static Activity mContext;
    private ArrayList<Inventory> mInventoryList = null;
    private DatabaseHelper mDatabaseHelper=null;

    public InventoryAdapter(Activity context, ArrayList<Inventory> inventoryList) {
        mContext = context;
        ...
        public InventoryViewHolder(View itemView,final int index) {
            ...
            menu.setOnClickListener((new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mPopupMenu.inflate(R.menu.inventory_options);
                    ...
                    mPopupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem menuItem) {
                            ...
                            if (menuItem.getItemId()==R.id.edit){
                                AddInventoryItems addInventoryFragment=new AddInventoryItems();
                                String[] split = ((String) view.getTag()).split(":");
                                int type = Integer.parseInt(split[0]);
                                final int index1= Integer.parseInt(split[1]);
                                addInventoryFragment.setInventoryItem(mInventoryList.get(index1),"edit");
                                InventoryActivity.replaceFragmentWithSlideAnimation(null, addInventoryFragment, true);
                            }
                            else if(menuItem.getItemId()==R.id.delete){
                                Inventory inventory=mInventoryList.get(index);
                                mDatabaseHelper.deleteInventory(inventory.getId());
                                remove(inventory.getId(),true);
                            }
                            return true;
                        }
                    });
...
//
    ...
    public InventoryViewHolder onCreateViewHolder(ViewGroup parent, int index) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list_inventory_items, parent, false);
